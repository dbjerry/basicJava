...
public class CardTest {
	...
	public static void main(String[] args) {
		...
		//3. Card클래스의 객체를 만드세요 변수명 cd1
		Card cd1 = new Card();
		
		//4. Card클래스의 객체를 만드세요 변수명 cd2
		Card cd2 = new Card();
		...
		System.out.println("cd1의 너비는 "+Card.width+"이고 높이는 "+Card.height+"이다.");
		// cd2의 모양은 HEART이고 숫자는 9이다.
		System.out.println("cd2의 모양은 "+cd2.kind+"이고 숫자는 "+cd2.number+"이다.");
		// cd2의 너비는 100이고 높이는 250이다.
		System.out.println("cd2의 너비는 "+Card.width+"이고 높이는 "+Card.height+"이다.");
		
		//10. cd1의 너비를 50으로, 높이를 80으로 변경하세요
		cd1.width = 50; //Card.width = 50;
		cd1.height = 80;//Card.heiht = 80;
		
		//11. 9번에서 만든 출력문장을 변경된 값으로 다시 출력하세요
		// cd1의 모양은 SPADE이고 숫자는 7이다.
		System.out.println("cd1의 모양은 "+cd1.kind+"이고 숫자는 "+cd1.number+"이다.");
		// cd1의 너비는 50이고 높이는 80이다.
		System.out.println("cd1의 너비는 "+cd1.width+"이고 높이는 "+cd1.height+"이다.");
		// cd2의 모양은 HEART이고 숫자는 9이다.
		System.out.println("cd2의 모양은 "+cd2.kind+"이고 숫자는 "+cd2.number+"이다.");
		// cd2의 너비는 50이고 높이는 80이다.
		System.out.println("cd2의 너비는 "+Card.width+"이고 높이는 "+Card.height+"이다.");
